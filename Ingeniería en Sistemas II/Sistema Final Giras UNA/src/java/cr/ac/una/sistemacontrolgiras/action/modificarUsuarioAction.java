 ...
 * @author Yari
 */
public class modificarUsuarioAction extends DispatchAction {
   ...
   public ActionForward iniciar(ActionMapping mapping, ActionForm form,
     ...
     public ActionForward modificarUsuario(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
