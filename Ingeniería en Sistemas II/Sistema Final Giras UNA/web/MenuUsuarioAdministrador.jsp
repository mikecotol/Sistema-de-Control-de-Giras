<%-- 
    Document   : MenuUsuarioAdministrador
    Created on : 18/06/2014, 09:24:15 PM
    Author     : Yari
--%>
        ...
        <div id='cssmenu'>
            <ul>
                ...
                <li><a href='#'<span><bean:message key="menuAdministrador.Giras"/></span></a>
                    <ul>
                        <li><a href='FuncionesAdministrativas.jsp'<span><h3><bean:message key="menuAdministrador.ingresarGira"/></h3></span></a></li>
                        ...
                        <li><a href='#'<span><h3><bean:message key="menuAdministrador.revisarSolicitudes"/></h3></span></a></li>
                    </ul>
                </li>
                <li><a href='#'<span><bean:message key="menuAdministrador.Vehiculos"/></span></a>
                    <ul>
                        ...
                        <li><a href='#'onclick="cargarPagina('./mostrarModificarAutomovil.do?metodo=iniciar')"<span><h3><bean:message key="menuAdministrador.modificarVehiculo"/></h3></span></a></li>
